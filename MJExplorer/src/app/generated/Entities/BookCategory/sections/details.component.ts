...
@RegisterClass(BaseFormSectionComponent, 'Book Categories.details') // Tell MemberJunction about this class 
@Component({
    selector: 'gen-bookcategory-form-details',
...
export class BookCategoryDetailsComponent extends BaseFormSectionComponent {
    @Input() override record: BookCategoryEntity | null = null;
    @Input() override EditMode: boolean = false;
}

export function LoadBookCategoryDetailsComponent() {
