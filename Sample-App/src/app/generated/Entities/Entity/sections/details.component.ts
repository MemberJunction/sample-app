...
@Component({
    ...
    <div *ngIf="this.EditMode" class="record-form">
        ...
        <div class="record-form-row">
            ...
            <kendo-textbox [(ngModel)]="record.NameSuffix"  />   
        </div>               
        <div class="record-form-row">
        ...
        <div class="record-form-row">
            ...
            <kendo-textbox [(ngModel)]="record.FullTextCatalog"  />   
        </div>               
        <div class="record-form-row">
        ...
        <div class="record-form-row">
            ...
            <kendo-textbox [(ngModel)]="record.FullTextIndex"  />   
        </div>               
        <div class="record-form-row">
        ...
        <div class="record-form-row">
            ...
            <kendo-textbox [(ngModel)]="record.FullTextSearchFunction"  />   
        </div>               
        <div class="record-form-row">
        ...
        <div class="record-form-row">
            ...
            <kendo-textbox [(ngModel)]="record.EntityObjectSubclassName"  />   
        </div>               
        <div class="record-form-row">
            <label class="fieldLabel">Entity Object Subclass Import</label>
            <kendo-textbox [(ngModel)]="record.EntityObjectSubclassImport"  />   
        </div>               
        <div class="record-form-row">
