...
@Component({
    ...
    <div *ngIf="this.EditMode" class="record-form">
        ...
        <div class="record-form-row">
            ...
            <kendo-textbox [(ngModel)]="record.EntityKeyField"  />   
        </div>               
        <div class="record-form-row">
            <label class="fieldLabel">Related Entity Join Field</label>
            <kendo-textbox [(ngModel)]="record.RelatedEntityJoinField"  />   
        </div>               
        <div class="record-form-row">
            <label class="fieldLabel">Join View</label>
            <kendo-textbox [(ngModel)]="record.JoinView"  />   
        </div>               
        <div class="record-form-row">
            <label class="fieldLabel">Join Entity Join Field</label>
            <kendo-textbox [(ngModel)]="record.JoinEntityJoinField"  />   
        </div>               
        <div class="record-form-row">
            <label class="fieldLabel">Join Entity Inverse Join Field</label>
            <kendo-textbox [(ngModel)]="record.JoinEntityInverseJoinField"  />   
        </div>               
        <div class="record-form-row">
